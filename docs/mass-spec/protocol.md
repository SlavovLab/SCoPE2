...
* Source data for figures
 ...
 - Figure 3: [Evaluating data acquisition and interpretation using diagnostic plots generated by DO-MS](https://doi.org/10.6084/m9.figshare.15060774.v1)

 - Figure 4: [Principal Component Analysis (PCA) of quantification results from SCoPE2 analysis](https://doi.org/10.6084/m9.figshare.15060789.v1)

 - Extended Data Figure 1: [The ABIRD device may suppress contaminant ions and enhance peptide identification](https://doi.org/10.6084/m9.figshare.15060846.v1)
