...
if(load_fresh){
  ...
  ev<-read.delim(paste0(path.t,"dat/fp94_97_dart/ev_updated.txt"))
  design<-read.csv("annotation_fp60-97.csv")
  batch<-read.csv("batch_fp60-97.csv")
  ...
  # Save imported data, to avoid slow reading times
  save(ev,design,batch, file = "prefilter_ev.RData")
